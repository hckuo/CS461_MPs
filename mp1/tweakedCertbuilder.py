...
def make_cert(netid, pubkey, ca_key = ECE422_CA_KEY, serial=0x190fe5d7c3145a24f5737082ae932777f7894fc9L): # use a static serial number to make the hash the same
